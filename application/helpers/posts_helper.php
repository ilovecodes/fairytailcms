<?php
	...
	function add_links_to_posts($posts) 
	{
		...
		foreach($posts as $post) {
			...
			$view_link = anchor_popup('posts/view_post/'.$post['id'].'/', 'View');
			$title_link = anchor_popup('posts/view_post/'.$post['id'].'/', $post['title']);
			$edit_link = anchor_popup('posts/edit_post/'.$post['id'].'/', 'Edit');
			$delete_link = $delete;
